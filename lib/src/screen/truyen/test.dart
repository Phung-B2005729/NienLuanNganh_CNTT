...
class TruyenChiTietScreent extends StatefulWidget {
  final String idtruyen;
  bool edit;
  TruyenChiTietScreent({super.key, required this.idtruyen, required this.edit});

  @override
  State<TruyenChiTietScreent> createState() => _TruyenChiTietScreentState();
}

class _TruyenChiTietScreentState extends State<TruyenChiTietScreent>
